<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.shipinyulan" label="视频预览" prop="shipinyulan">
          <file-upload
          tip="点击上传视频预览"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.shipinyulan?ruleForm.shipinyulan:''"
          @change="shipinyulanUploadChange"
          ></file-upload>
        </el-form-item> 
        <div v-else>
          <el-form-item v-if="ruleForm.shipinyulan" label="视频预览" prop="shipinyulan">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.shipinyulan)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.feiyong = true;
          ...
          if(o=='shipinyulan'){
            this.ruleForm.shipinyulan = obj[o];
	    this.ro.shipinyulan = true;
            continue;
          }
          if(o=='kechengneirong'){
	...
	this.ruleForm.kechengneirong = this.ruleForm.kechengneirong.replace(reg,'../../../springboot760av/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.shipinyulan!=null) {
		this.ruleForm.shipinyulan = this.ruleForm.shipinyulan.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    shipinyulanUploadChange(fileUrls) {
	this.ruleForm.shipinyulan = fileUrls;
	this.addEditUploadStyleChange()
    },
