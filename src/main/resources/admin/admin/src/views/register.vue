  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="账号" class="input" v-if="tableName=='jiazhang'">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='jiazhang'">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='jiazhang'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      if((!this.ruleForm.zhanghao) && `jiazhang` == this.tableName){
      ...
      if((!this.ruleForm.xingming) && `jiazhang` == this.tableName){
