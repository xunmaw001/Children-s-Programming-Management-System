<template>
  <div>
    ...
    >  
     <el-row>
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiazhang'"  label="账号" prop="zhanghao">
          <el-input v-model="ruleForm.zhanghao" readonly              placeholder="账号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiazhang'"  label="姓名" prop="xingming">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      if((!this.ruleForm.zhanghao)&& 'jiazhang'==this.flag){
      ...
      if((!this.ruleForm.xingming)&& 'jiazhang'==this.flag){
